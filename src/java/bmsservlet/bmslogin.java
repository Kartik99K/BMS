...
public class bmslogin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Class.forName("com.mysql.cj.jdbc.Driver");   
           ...
           PreparedStatement pstmt=conn.prepareStatement("insert into bmslogin values(?,?,?,?,?,?)");
           String s1 = request.getParameter("fname");
           String s2 = request.getParameter("lname");
           String s3 = request.getParameter("pw");
           String s4 = request.getParameter("day");
           String s5 = request.getParameter("month");
           String s6 = request.getParameter("year");
